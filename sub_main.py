...
def sendEmail(sender_email_address, email_key, receiver_email, message, id):
    ...
    if cursor.fetchone():
        ...
        cursor.execute("CREATE TABLE IF NOT EXISTS email_data (uid	INTEGER NOT NULL,receiver_email	TEXT NOT NULL,message	TEXT NOT NULL,FOREIGN KEY(uid) REFERENCES users(id));")
        try:
