...
class MiddleLeftFrame(customtkinter.CTkFrame):
    def __init__(self, master):
        ...
        home_button_image = customtkinter.CTkImage(Image.open("images/home.png"))
...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        def addWhatsAppNomber():
            ...
            reciever_name.place(relx=0.15, rely=0.25)
            receiver_mobile_number = customtkinter.CTkEntry(addwhatsappnomber, placeholder_text="Mobile Number")
